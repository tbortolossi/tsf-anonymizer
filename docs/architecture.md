...
| public IPv4 | `8.8.8.8` | `192.0.2.x` … | RFC 5737 documentation ranges |
...
(`Anonymizer._fakes`). Fake IPs skip any address seen as an original; when a
customer really uses 100.64/10 the compare reports a *collision*, separately
from leaks.
